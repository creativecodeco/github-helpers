...
* **Configuración del Agente**: Adición de directrices de codificación para asistentes de IA en [.agents/AGENTS.md](file:///Users/joaltoroc/Code/creativecodeco/github-helpers/.agents/AGENTS.md).
...
### 🐳 Docker & Despliegue
* **Mitigación de Fuga de Datos**: Corrección en las instrucciones `COPY` del [Dockerfile](file:///Users/joaltoroc/Code/creativecodeco/github-helpers/Dockerfile) sustituyendo los patrones glob con comodines (`*`) por nombres de archivo explícitos (`pnpm-lock.yaml`, `pnpm-workspace.yaml`).
* **Documentación de Persistencia**: Actualización de [README.md](file:///Users/joaltoroc/Code/creativecodeco/github-helpers/README.md) con las instrucciones para montar un volumen persistente en `/usr/src/app/data` y evitar la pérdida de la base de datos de métricas SQLite al recrear contenedores en Docker o Coolify.
